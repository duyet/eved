---
description: Background on Duyet (duyet.net) — who he is, his expertise, his projects, and all his links (sites, CV, GitHub, LinkedIn, X). Load when asked about Duyet, his work, his projects, or how to find, follow, or contact him.
---

# About Duyet

**Duyet Le** — Senior Data & AI Engineer, based in Vietnam. Builds data platforms and
...
- **duyet-mcp-server** — the MCP server behind the `duyet` connection.
...
For live, authoritative details — current CV, latest posts, recent GitHub activity — use
the **duyet** connection (it can list blog posts and fetch post content) rather than this
static summary.
